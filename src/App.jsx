...
async function aiClassify(text) {
  try {
    const parts = ["Voce e um assistente de residencia medica. Analise o texto e retorne APENAS JSON valido sem markdown com esta estrutura: area sendo uma de Clinica Medica ou Clinica Cirurgica ou Pediatria ou Ginecologia e Obstetricia ou Preventiva e Social, e titulo sendo um titulo curto em portugues com no maximo 4 palavras. Texto: ", text.slice(0, 400)];
